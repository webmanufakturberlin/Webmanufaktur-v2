...
export default function VoxelScene() {
  ...
  useFrame((state, delta) => {
    ...
    for (let i = 0; i < INSTANCE_COUNT; i++) {
      ...
      // 1. HERO (Progress 0 - 0.15): Central Island
      if (progress < 0.2) {
      ...
      // 2. VALUE PROP (Progress 0.15 - 0.35): Three Towers
      ...
      // 3. SERVICES (Progress 0.35 - 0.55): Exploding Grid
      ...
      // 4. PROCESS (Progress 0.55 - 0.75): Conveyor Belt
