...
import { Send, Loader2, Building2, Globe, Wrench, Briefcase, Mail } from 'lucide-react';
        ...
        <footer className="relative z-10 bg-white/80 backdrop-blur-xl pt-32 pb-12 px-4 border-t border-white/20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24 relative">
                ...
                <Reveal delay={0.2} width="100%">
                    <section className="bg-white rounded-[2rem] p-8 md:p-10 border border-gray-100 shadow-2xl shadow-blue-900/5 relative overflow-hidden" aria-labelledby="project-form-heading">
                        ...
                        <h3 id="project-form-heading" className="text-2xl font-bold mb-8 text-ink">{t('cta.projectDetails')}</h3>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        type="text"
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:bg-white focus-visible:ring-2 focus-visible:ring-blue-500 transition-all placeholder-gray-300"
                            ...
                            <fieldset>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    ${formData.projectType === 'new' ? 'border-blue-500 bg-blue-50/50 text-blue-700' : 'border-gray-200 bg-gray-50 text-gray-500 hover:bg-gray-100'}
                                `}>
                                        <input
                                            type="radio"
                                            name="projectType"
                                    ...
                                    cursor-pointer border rounded-xl p-4 flex items-center gap-3 transition-all
                                    focus-within:ring-2 focus-within:ring-blue-500
                                    ${formData.projectType === 'rework' ? 'border-purple-500 bg-purple-50/50 text-purple-700' : 'border-gray-200 bg-gray-50 text-gray-500 hover:bg-gray-100'}
                                `}>
                                        <input
                                            type="radio"
                                            name="projectType"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={3}
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:bg-white focus-visible:ring-2 focus-visible:ring-blue-500 transition-all resize-none placeholder-gray-300"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full relative overflow-hidden bg-black text-white font-bold py-4 rounded-xl group disabled:opacity-70 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 transition-transform"
                            >
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 relative">
                ...
                <div className="flex gap-6 mt-4 md:mt-0">
                    <a href="#" className="hover:text-ink transition-colors hover:underline decoration-blue-500 underline-offset-4 focus-visible:ring-2 focus-visible:ring-blue-500 rounded-md px-1">{t('cta.imprint')}</a>
