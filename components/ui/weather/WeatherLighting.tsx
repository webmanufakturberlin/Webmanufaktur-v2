...
const PRESETS: Record<string, LightPreset> = {
  ...
  rain_day:           { ambient: { color: '#606870', intensity: 2.0 }, directional: { color: '#a0b0c0', intensity: 1.2 }, hemisphere: { sky: '#8090a0', ground: '#2a2520', intensity: 0.6 }, fog: { color: '#9aacbb', density: 0.001 } },
