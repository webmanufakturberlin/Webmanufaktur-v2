          ...
          {stats.map((stat, idx) => (
            <Reveal key={idx} width="100%" delay={idx * 0.1}>
              <div className="text-center px-4 pt-8 md:pt-0 group cursor-default">
                <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-gray-900 to-gray-500 mb-4 pb-2 tracking-tight group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-500">
                  {stat.value}
                </div>
